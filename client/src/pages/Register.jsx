       ...
       <div className='bg-white my-4 w-full max-w-lg mx-auto rounded p-8'>
         ...
         <form className='grid gap-4 mt-6' onSubmit={handleSubmit}>
            <div className='grid gap-1'>
                ...
                <input type='text' id='name' autoFocus placeholder='Enter your name' className='bg-blue-50 p-1.5 border rounded outline-none focus:border-green-700 ' name='name' value={data.name} onChange={handleChange}></input>
            </div>
            ...
            <div className='grid gap-1'>
                ...
                <div className='bg-blue-50 p-1.5 border rounded flex items-center focus-within:border-green-700 '>
                     <input type={showConfirmPassword ? "text":"password"} id='confirmPassword'  placeholder='Enter your password' className='w-full outline-none ' name='confirmPassword' value={data.confirmPassword} onChange={handleChange}></input>
