       ...
       <p className='font-semibold text-lg mb-2'>Enter Your  Password</p>
         ...
         <form className='grid gap-4 py-4' onSubmit={handleSubmit}>
            ...
            <div className='grid gap-1'>
                <label htmlFor='newPassword'>New Password</label>
                                <div className='bg-blue-50 p-1.5 border rounded flex items-center focus-within:border-green-700 '>
                                     <input type={showPassword ? "text":"password"} id='password'  placeholder='Enter your new password' className='w-full outline-none ' name='newPassword' value={data.newPassword} onChange={handleChange}></input>
            ...
            <label htmlFor='confirmPassword'>Confirm Password</label>
                                <div className='bg-blue-50 p-1.5 border rounded flex items-center focus-within:border-green-700 '>
                                     <input type={showConfirmPassword ? "text":"password"} id='password'  placeholder='Enter your confirm password' className='w-full outline-none ' name='confirmPassword' value={data.confirmPassword} onChange={handleChange}></input>
